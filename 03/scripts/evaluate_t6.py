...
MODEL_PRICING = {
    ...
    # August 2026 rerun (OpenRouter list prices as of 2026-08-10; claude-sonnet-5 at intro pricing)
    ...
    "deepseek-v4-flash": {"in": 0.08, "out": 0.18},
    "gpt-5.6-luna": {"in": 0.1, "out": 0.6},
    "gpt-5.6-luna-pro": {"in": 0.1, "out": 0.6},
    "gpt-5.6-sol": {"in": 5.0, "out": 30.0},
    "gpt-5.6-sol-pro": {"in": 5.0, "out": 30.0},
    "gpt-5.6-terra": {"in": 1.0, "out": 6.0},
    "gpt-5.6-terra-pro": {"in": 1.0, "out": 6.0},
}
...
def main():
    ...
    responses_dir = DATA / "responses_t6"
    all_responses = []
    ...
    # Save scores CSV
    with open(DATA / "scores_t6.csv", "w", newline="") as f:
    ...
    with open(DATA / "accuracy_summary_t6.csv", "w", newline="") as f:
