#!/usr/bin/env python3
"""
Experiment 03: T6 extension: all 22 models on 10 additional harder ClickHouse questions × 3 runs.
...
RESP_DIR = DATA_DIR / "responses_t6"
...
# ── Models ─────────────────────────────────────────────────────────────────────
# August 2026 rerun: successor models only (Feb 2026 originals in call_llms.py)
MODELS = {
...
with open(DATA_DIR / "questions_t6.json") as f:
